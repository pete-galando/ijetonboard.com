...
?>
    <section>
        <h1>About Us</h1>
        <p>
        iJet's vision for the intelligent aircraft is to help our airline customers generate new sources of revenue, reduce costs, and improve operational efficiency. We begin by changing the way applications are delivered to the aircraft. iJet will deliver a broad array of integrated solutions, services and data analytics to help our Customers achieve key tactical and strategic objectives and thrive amid environmental concerns and operational, economic and regulatory challenges.</p>
        <p>
